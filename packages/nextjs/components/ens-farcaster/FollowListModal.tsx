...
export const FollowListModal = ({ isOpen, onClose, title, names }: FollowListModalProps) => {
    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-base-100/80 backdrop-blur-xl transition-all animate-fade-in" onClick={onClose}>
            <div
            ...
            >
                ...
                <div className="flex items-center justify-between p-6 border-b border-white/5 bg-white/5">
                    ...
                    <button onClick={onClose} className="btn btn-ghost btn-sm btn-circle hover:bg-white/10 opacity-50 hover:opacity-100 transition-all">
